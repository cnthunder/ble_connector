...
class BLEDeviceConnector(QMainWindow):
    ...
    def start_scan(self):
        ...
        try:
            ...
            ble_scan_path = get_resource_path('ble-scan.exe')
            self.scan_process.start(ble_scan_path)
    ...
    def connect_to_device(self, mac: str, name: str = ""):
        ...
        try:
            ...
            ble_serial_path = get_resource_path('ble-serial.exe')
            self.connection_process.start(ble_serial_path, ['-d', mac])
